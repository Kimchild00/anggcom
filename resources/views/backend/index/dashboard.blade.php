                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-uppercase mb-1">Total User Company</div>
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $userCompanyCount }}</div>
